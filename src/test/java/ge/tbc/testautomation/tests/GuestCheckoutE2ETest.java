...
public class GuestCheckoutE2ETest extends BaseTest {
    ...
    @Story("Guest user full purchase journey")
    ...
    public void step5_fillShippingAndProceed() {
        ...
        purchaseSteps.fillGuestShippingDetailsAndProceed(
                guestEmail, MagnetoConstants.GUEST_FIRST_NAME, MagnetoConstants.GUEST_LAST_NAME,
                MagnetoConstants.GUEST_STREET_ADDRESS, MagnetoConstants.GUEST_CITY, MagnetoConstants.GUEST_COUNTRY,
                MagnetoConstants.GUEST_STATE_PROVINCE, MagnetoConstants.GUEST_POST_CODE, MagnetoConstants.GUEST_PHONE_NUMBER
        );
    }
